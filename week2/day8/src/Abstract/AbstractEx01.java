...
abstract class Animal{ // 추상클래스
    ...
    void introduce(){ // 공통적으로 toString을 통해 강아지와 개의 이름 및 정보에 대한 문자열이 반환된 후에 추가적으로 문장끝에
        ...
        // introduce 메서드 내로 들어오게 되면 자손의 dog가 실행되고 만약에 조상에 dog()가 오버로딩이 돼있지 않으면 컴파일 에러 발생
...
class Cat extends Animal{
    ...
    public String toString(){// Cat과 Dog에서 구현해야하는 toString의 내용이 다르기 떄문에
        ...
        // Animal의 오버라이딩 일 것이고 안해놨으면 Object클래스의 오버라이딩이다. 그러나 굳이 Animal 클래스에서는
