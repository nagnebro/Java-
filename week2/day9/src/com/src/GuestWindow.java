...
class GuestWindow2 extends JFrame {
    // 그래픽 프레임창의 기본설정은 생성자 안에다가 설정.
    public GuestWindow2(String title){ // 제목을 받아오겠다.
        setLayout(null);
        // 창을 보겠냐
    ...
    public void initContainer(String title, int x, int y, int width, int height){ // 컴포넌트 (버튼, 텍스트필드, 라벨, 이미지) 이러한 컴포넌트를 모아놓은 것을 container라고 한다.
        ...
        userPanel.setBounds(600,200,300,150);

        // 아이콘 (고양이 가져와서 아이콘 객체 생성)
        // 상대경로 . 점으로 현재 폴더를 뜻함( src )
        ImageIcon imageIcon = new ImageIcon("./images1/user.png"); // 현재폴더에서 상대경로를 입력해줌
        ...
        titlePanel.setBounds(600,350,300,100);
        ...
        namePanel.setBounds(600,450,300,50); // 창의 위치와 크기 조절.
        ...
        phonePanel.setBounds(600,500,300,50); // 창의 위치와 크기 조절.
        ...
        buttonPanel.setBounds(600,550,300,50); // 창의 위치와 크기 조절.
        add(buttonPanel);
