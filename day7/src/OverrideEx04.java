...
class Wizard1 extends Novice {
    // 필드
    protected int mp;

    // 생성자
    public Wizard1(String name, int hp, int mp) {
        super(name, hp);
        this.mp = mp;
    }
...
class GreatWizard extends Wizard1 {
    /* 1. 보호막 속성을 필드에 추가하시오. */
    int shield;
    ...
    public String toString() {
        ...
        // toString의 리턴을 좀 더 효율적으로 하기 위한 String.format.
    }
    /* 4. 에너지볼트 마법을 오버라이딩 하시오. */
    public void energeVolt() {
        System.out.printf("%s의 더 강해진 에너지볼트!\n", this.name);
    }
}
