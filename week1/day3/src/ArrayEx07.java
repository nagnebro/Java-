        ...
        public static void main(String[] args) {
            ...
            for ( int i = 0 ; i<apt.length ; i++){
                for( int j = 0 ; j<apt[i].length ; j++){
                    sum1 += pay[i][j];
                }System.out.printf(" %d층 관리비의 합은 %d 입니다 \n",i+1,sum1);
                sum1 = 0;
            }
            ...
            System.out.print("호수를 입력하시면 해당 호수의 관리비가 출력됩니다");
            int input = sc.nextInt();

            Out: for ( int i = 0 ; i<apt.length ; i++){
                for( int j = 0 ; j<apt[i].length ; j++){
                    if ( input == apt[i][j]){
                        System.out.printf("%d호의 관리비는 %d입니다 \n",apt[i][j],pay[i][j]);
                        break Out;
                    }
                }
            }
            ...
            int max = 0, min = pay[0][0], maxho = 0, minho = 0;
            for ( int i = 0 ; i<apt.length ; i++){
            ...
            System.out.printf(" 관리비가 가장 많이 나온 집은 %d, 가장 적게 나온 집은 %d입니다",maxho,minho);
